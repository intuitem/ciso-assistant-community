...
![Version: 0.3.1](https://img.shields.io/badge/Version-0.3.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.2.4](https://img.shields.io/badge/AppVersion-v2.2.4-informational?style=flat-square) 
...
| ingress.existingSecret | string | `""` | Use existing TLS secret |
