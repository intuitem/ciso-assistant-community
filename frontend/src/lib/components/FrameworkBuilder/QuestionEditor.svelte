				...
				<div class="grid grid-cols-3 gap-2">
					<label class="block">
						...
						<input
							type="number"
							value={sliderMin}
							class="w-full text-sm border border-surface-200-800 rounded px-2 py-1 focus:border-blue-500 outline-hidden focus-visible:ring-2 focus-visible:ring-blue-500/40"
			...
			{#if $activeLanguageStore}
				...
				<div class="grid grid-cols-2 gap-3">
					...
					<textarea
						...
						rows="2"
						class="w-full text-sm border border-surface-200-800 rounded-lg px-3 py-2 focus:border-blue-500 outline-none focus-visible:ring-2 focus-visible:ring-blue-500/40 resize-none"
						onblur={(e) => {
							saveField(
								'translations',
