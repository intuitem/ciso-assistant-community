...
>
	...
	<Accordion.Item value="analyticsDefaults">
		<Accordion.ItemTrigger class="flex w-full items-center cursor-pointer">
		...
		<Accordion.ItemContent>
			<div class="p-4">
				<Select
					...
					options={model.selectOptions?.['default_custom_analytics_dashboard'] ?? []}
					label={m.defaultCustomAnalyticsDashboard()}
					helpText={m.defaultCustomAnalyticsDashboardHelpText()}
					translateOptions={false}
				/>
			</div>
		</Accordion.ItemContent>
