...
export function genericUrlmodelIdGET(urlModel: urlModel): typeof urlmodelIdGET {
  return async (event) => urlmodelIdGET({
    ...event,
    params: {...event.params, model: urlModel }
  });
}

export const urlmodelIdPATCH: RequestHandler<ParamsUrlmodelId> = async ({ fetch, params, request }) => {
	const model = getModelInfo(params.model);
	const endpoint = `${BASE_API_URL}/${model.endpointUrl ?? params.model}/${params.id}/`;
...
export function genericUrlmodelIdPATCH(urlModel: urlModel): typeof urlmodelIdPATCH {
  return async (event) => urlmodelIdPATCH({
    ...event,
    params: {...event.params, model: urlModel }
  });
}
...
export function genericUrlmodelGET(urlModel: urlModel): typeof urlmodelGET {
  return async (event) => urlmodelGET({
    ...event,
    params: {...event.params, model: urlModel }
  });
}
...
export const thirdPartyUrlmodelGET: RequestHandler<ParamsThirdPartyUrlmodelId> = async ({ fetch, params, url }) => {
  const model = getModelInfo(params.model);
  const endpoint = `${BASE_API_URL}/${model.endpointUrl ? model.endpointUrl : params.model}/${
    url.searchParams ? '?' + url.searchParams.toString() : ''
  }`;
 ...
 * ```
*/
export function genericThirdPartyUrlmodelGET(urlModel: thirdPartyUrlModel): typeof thirdPartyUrlmodelGET {
  return async (event) => thirdPartyUrlmodelGET({
    ...event,
    params: {...event.params, model: urlModel }
  });
}

export const urlmodelIdFieldGET: RequestHandler<ParamsUrlmodelIdField> = async ({ fetch, params, url }) => {
	const model = getModelInfo(params.model);
 ...
 * ```
*/
export function genericUrlmodelIdFieldGET(urlModel: urlModel, field: string): typeof urlmodelIdFieldGET {
  return async (event) => urlmodelIdGET({
    ...event,
...
export const urlmodelIdFieldPATCH: RequestHandler<ParamsUrlmodelIdField> = async ({ fetch, params, request }) => {
	const model = getModelInfo(params.model);
	const endpoint = `${BASE_API_URL}/${model.endpointUrl ?? params.model}/${params.id}/`;
 ...
 * ```
*/
export function genericUrlmodelIdFieldPATCH(urlModel: urlModel, field: string): typeof urlmodelIdFieldPATCH {
  return async (event) => urlmodelIdPATCH({
    ...event,
    params: {...event.params, model: urlModel, field }
  });
