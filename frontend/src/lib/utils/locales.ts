...
export function localItems(languageTag: string): LocalItems {
	const LOCAL_ITEMS = {
		...
		birdEye: m.birdEye({ languageTag: languageTag }),
		calendar: m.calendar({ languageTag: languageTag }),
		schedules: m.schedules({ languageTag: languageTag }),
		...
		assetInventory: m.assetInventory({ languageTag: languageTag }),
		asset: m.asset({ languageTag: languageTag }),
		policies: m.policies({ languageTag: languageTag }),
		policiesAndProcedures: m.policiesAndProcedures({ languageTag: languageTag }),
		...
		patchManagement: m.patchManagement({ languageTag: languageTag }),
		...
		complianceAuditReports: m.complianceAuditReports({ languageTag: languageTag }),
