...
export const ValidationFlowSchema = z.object({
	...
	approver: z.string(),
	accept_notes: z.string().optional().nullable(),
	rejection_notes: z.string().optional().nullable(),
	revocation_notes: z.string().optional().nullable(),
	changes_request_notes: z.string().optional().nullable(),
	drop_notes: z.string().optional().nullable(),
	resubmission_notes: z.string().optional().nullable(),
