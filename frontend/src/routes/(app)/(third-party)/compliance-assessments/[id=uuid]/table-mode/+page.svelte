							...
							{#if requirementAssessment.assessable}
								...
								>
									{#if !questionnaireMode}
										<div class="flex flex-row w-full space-x-2 my-4">
											...
											<div class="flex flex-col items-center w-1/2">
												...
												{#if Object.values(requirementAssessment.requirement.questions || {}).some((question) => Array.isArray(question.choices) && question.choices.some((choice) => choice.compute_result))}
													<span
									...
									<div class="flex flex-col w-full place-items-center">
										{#if !shallow}
											{#if Object.values(requirementAssessment.requirement.questions || {}).some((question) => Array.isArray(question.choices) && question.choices.some((choice) => choice.add_score))}
