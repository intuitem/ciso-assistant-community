...
<div
	class="w-full h-full rounded-xl transition-all duration-200 overflow-hidden border-2 border-dashed {data.twBorder} {data.twBg} cursor-grab active:cursor-grabbing"
