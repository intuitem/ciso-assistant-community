...
{@debug data}
<div class="p-4 text-lg font-black underline underline-offset-4 decoration-4 decoration-pink-500">
	Controls
</div>
...
<div class="p-4 text-lg font-black underline underline-offset-4 decoration-4 decoration-green-300">
	Audits
</div>
<div class="p-4 text-left">
	<div class="relative overflow-x-auto shadow-lg rounded-lg">
				...
				{#each data.data.audits as ca}
					<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
						<th
							...
							class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"
						>
							<a href="/compliance-assessments/{ca.id}" class="hover:text-violet-400">{ca.name}</a>
						</th>
						<td class="px-6 py-4"> {safeTranslate(ca.status) ?? '-'} </td>
						<td class="px-6 py-4"> {formatDateOrDateTime(ca.eta, languageTag()) ?? '-'} </td>
					</tr>
				{/each}
			</tbody>
		</table>
...
<div class="p-4 text-lg font-black underline underline-offset-4 decoration-4 decoration-orange-300">
	Risk assessments
</div>
<div class="p-4 text-left">
	<div class="relative overflow-x-auto shadow-lg rounded-lg">
...
<div class="p-4 text-lg font-black underline underline-offset-4 decoration-4 decoration-purple-300">
	Owned risks
</div>
<div class="p-4 text-left">
	<div class="relative overflow-x-auto shadow-lg rounded-lg">
