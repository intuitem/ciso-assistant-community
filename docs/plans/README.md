...
| [T3 — Maturidade TSI + Terceiros](PLAN-BR-T3-TSI-TERCEIROS.md) | Jornada guiada de maturidade de TI/SI (NIST CSF 2.0 tropicalizado) + Gestão de Terceiros aprofundada | 📋 Proposto (design aprovado) | T2 |
| [T4 — Rebranding visual](PLAN-BR-T4-REBRANDING.md) | Nome, logo, cores, tropicalização de marca | 📋 Proposto (não desenhado — precisa de brainstorm próprio) | — |

**Ordem recomendada:** T1 ∥ T2 (concluídos, independentes) → T3 → T4 (T4 pode rodar em paralelo a T3, mas idealmente aplica a marca final sobre uma jornada já estável).
