# BR — Tropicalização: CISO TSI (planos)

**CISO TSI** é um fork comercial white-label do CISO Assistant Community, adaptado para o mercado brasileiro: conteúdo regulatório nacional (LGPD), idioma pt-BR completo, jornada de maturidade de TI/SI + Gestão de Terceiros, e identidade visual própria. Ver [MASTER](PLAN-BR-MASTER.md).
