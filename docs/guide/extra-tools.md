...
You can go further by exploring its [glossary](https://app.gitbook.com/s/UJGpmCYDFJNsz2CDasSm/model), or checking the [data model](https://github.com/intuitem/ciso-assistant-community/blob/main/documentation/architecture/data-model.md) directly on GitHub.
