...
{% hint style="info" %}
**Automatic** is the default. It derives the format from your interface language — for example, English shows `5/31/2026` while French shows `31/05/2026`. Pick any of the explicit formats to keep the same layout regardless of language. See [Changing the language](language.md).
{% endhint %}
