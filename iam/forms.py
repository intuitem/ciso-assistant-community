...
from django.forms import (CheckboxInput, DateInput, DateTimeInput, EmailInput,
                          HiddenInput, ModelForm, NullBooleanSelect,
                          NumberInput, PasswordInput, Select, SelectMultiple,
                          Textarea, TextInput, TimeInput, URLInput,
                          ValidationError)
...
from .models import Folder, Role, RoleAssignment, User, UserGroup
...
class FolderUpdateForm(StyledModelForm):
    ...
    class Meta:
        """ for Model """
        model = Folder
        exclude = ['content_type', 'builtin', 'hide_public_threat', 'hide_public_security_function', 'parent_folder', 'locale_data']
