...
DISABLE_MFA_URL = "/api/iam/disable-mfa/"
...
class TestDisableMFAView:
    def test_admin_can_disable_another_users_mfa(
    ...
    def test_non_admin_cannot_disable_mfa(self, regular_client, target_user_with_mfa):
