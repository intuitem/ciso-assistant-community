# Generated by Django 5.1.10 on 2025-08-26 16:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('folder', models.ForeignKey(default=iam.models.Folder.get_root_folder_id, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_folder', to='iam.folder')),
                ('quantitative_risk_aggregations', models.ManyToManyField(blank=True, related_name='hypotheses', to='crq.quantitativeriskaggregation', verbose_name='Quantitative Risk Aggregations')),
