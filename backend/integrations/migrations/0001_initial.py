    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_sync_direction', models.CharField(choices=[('push', 'Push'), ('pull', 'Pull')], max_length=10)),
                ('version', models.IntegerField(default=1)),
                ('error_message', models.TextField(blank=True)),
                ('configuration', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='integrations.integrationconfiguration')),
            ],
        ),
        migrations.CreateModel(
            name='SyncEvent',
            fields=[
                ...
                ('mapping', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='integrations.syncmapping')),
            ],
        ),
        migrations.AddIndex(
