...
AUTH_TOKEN_AUTO_REFRESH_MAX_TTL = int(
    os.environ.get("AUTH_TOKEN_AUTO_REFRESH_MAX_TTL", default=60 * 60 * 10)
...
REST_KNOX = {
    ...
    "AUTO_REFRESH_MAX_TTL": AUTH_TOKEN_AUTO_REFRESH_MAX_TTL,
