# Generated by Django 5.1.10 on 2025-07-09 10:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.CharField(blank=True, choices=[('server', 'Server'), ('computer', 'Computer'), ('cloud', 'Cloud'), ('file', 'File'), ('diamond', 'Diamond'), ('phone', 'Phone'), ('cube', 'Cube'), ('blocks', 'Blocks'), ('shapes', 'Shapes'), ('network', 'Network'), ('database', 'Database'), ('key', 'Key')], help_text='Icon representing the elementary action', max_length=100, verbose_name='Icon')),
