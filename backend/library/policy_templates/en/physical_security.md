...
description: Controls for protecting physical premises, equipment, and information assets
---
...
This policy defines the physical and environmental security controls required to protect [Organization Name]'s premises, equipment, and information assets from unauthorized access, damage, and interference.

## 2. Scope

This policy applies to all facilities owned, leased, or operated by [Organization Name], including offices, data centers, server rooms, and remote work locations.
...
- **Facilities Management**: Implement and maintain physical security controls, manage access systems.
- **IT Security Team**: Define physical security requirements, conduct risk assessments.
- **All Employees**: Comply with physical security procedures, report security concerns, challenge unescorted visitors.
- **Reception/Security Staff**: Manage visitor registration and monitor access points.
...
This policy shall be reviewed at least annually or upon significant changes to facilities, threat landscape, or organizational requirements.
