...
description: Requirements for information security awareness, education, and training programs
---
...
This policy establishes the requirements for information security awareness and training programs at [Organization Name] to ensure all personnel understand their security responsibilities and can identify and respond to threats.

## 2. Scope

This policy applies to all employees, contractors, temporary staff, and third parties with access to [Organization Name]'s information systems and data.
...
- **IT Security Team**: Design, deliver, and maintain the awareness and training program.
- **Human Resources**: Integrate security training into onboarding and track completion.
- **Managers**: Ensure their team members complete required training on time.
- **All Personnel**: Participate in training, apply security practices, and report concerns.

## 9. Compliance

Failure to complete mandatory training may result in restricted system access. Repeated non-compliance may result in disciplinary action.

## 10. Policy Review

This policy shall be reviewed at least annually or upon significant changes in the threat landscape, organizational structure, or regulatory requirements.
