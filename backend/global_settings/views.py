...
class GeneralSettingsViewSet(viewsets.ModelViewSet):
    ...
    def ebios_radar_parameters(self, request):
        ebios_rm_parameters = {
            ...
            "ebios_radar_green_zone_radius": self.get_object().value.get("ebios_radar_green_zone_radius"),
            "ebios_radar_yellow_zone_radius": self.get_object().value.get("ebios_radar_yellow_zone_radius"),
            "ebios_radar_red_zone_radius": self.get_object().value.get("ebios_radar_red_zone_radius"),
        }
