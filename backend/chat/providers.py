...
TOOL_SYSTEM_PROMPT = (
    ...
    "create, add, or import items. Supported types include: controls, assets, threats, "
    "risk scenarios, evidences, vulnerabilities, security exceptions, incidents, "
    "entities, solutions, EBIOS RM studies, feared events, RoTo couples, stakeholders, "
    "strategic scenarios, attack paths, and operational scenarios. "
    ...
    "When on a parent detail page (e.g. risk assessment, EBIOS RM study), child objects "
    "will be automatically linked to the parent.\n"
