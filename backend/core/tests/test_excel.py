...
class TestExcelUploadHandler:
    ...
    def test_process_upload_success_basic(self, mock_load_workbook, excel_handler, valid_excel_content, mock_sandbox):
    ...
    @patch("core.excel.openpyxl.load_workbook")
    def test_process_upload_v1_conversion(self, mock_load_workbook, excel_handler, valid_excel_content, mock_sandbox):
    ...
    @patch("core.excel.openpyxl.load_workbook")
    def test_process_upload_cis_prep(self, mock_load_workbook, excel_handler, valid_excel_content, mock_sandbox):
    ...
    @patch("core.excel.openpyxl.load_workbook")
    def test_process_upload_sandbox_violation(self, mock_load_workbook, excel_handler, valid_excel_content, mock_sandbox):
        mock_wb = MagicMock()
    ...
    @patch("core.excel.openpyxl.load_workbook")
    def test_process_upload_timeout(self, mock_load_workbook, excel_handler, valid_excel_content, mock_sandbox):
        mock_wb = MagicMock()
        mock_wb.sheetnames = ["library_meta"]
        mock_load_workbook.return_value = mock_wb
