    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rationale', models.CharField(choices=[('syntactic', 'Syntactic'), ('semantic', 'Semantic'), ('functional', 'Functional')], max_length=20, verbose_name='Rationale')),
                ('annotation', models.TextField(blank=True, null=True, verbose_name='Annotation')),
                ('reference_requirement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.requirementnode', verbose_name='Reference requirement')),
                ('related_requirements', models.ManyToManyField(related_name='related_requirements', to='core.requirementnode', verbose_name='Related requirements')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_framework', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_framework', to='core.framework', verbose_name='Related framework')),
            ],
            options={
                'abstract': False,
            },
