...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RenameField(
            model_name='appliedcontrol', old_name='security_function', new_name='reference_control',
        ),
        migrations.RenameField(
            model_name='requirementassessment', old_name='security_measures', new_name='applied_controls',
        ),
        migrations.RenameField(
            model_name='requirementnode', old_name='security_functions', new_name='reference_controls',
        ),
        migrations.RenameField(
            model_name='riskscenario', old_name='security_measures', new_name='applied_controls',
        ),
        ...
        migrations.AlterField(
            ...
            field=models.TextField(blank=True, help_text='The existing controls to manage this risk. Edit the risk scenario to add extra applied controls.', max_length=2000, verbose_name='Existing controls'),
        ),
