...
class Migration(migrations.Migration):
    ...
    replaces = [('core', '0001_initial'), ('core', '0002_initial'), ('core', '0003_alter_riskscenario_strength_of_knowledge'), ('core', '0004_complianceassessment_is_published_and_more'), ('core', '0005_alter_project_lc_status_alter_securitymeasure_effort'), ('core', '0006_remove_securitymeasure_security_function_and_more'), ('core', '0007_alter_requirementlevel_framework_and_more'), ('core', '0008_alter_complianceassessment_status_and_more'), ('core', '0009_framework_max_score_framework_min_score_and_more'), ('core', '0010_rename_score_definition_framework_scores_definition_and_more'), ('core', '0011_auto_20240501_1342'), ('core', '0012_alter_appliedcontrol_updated_at_and_more'), ('core', '0013_requirementnode_typical_evidence'), ('core', '0014_auto_20240522_1731')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_assets', models.ManyToManyField(blank=True, to='core.asset', verbose_name='parent assets')),
            ],
            options={
                'verbose_name': 'Asset',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dependencies', models.ManyToManyField(blank=True, to='core.library', verbose_name='Dependencies')),
                ('folder', models.ForeignKey(default=iam.models.Folder.get_root_folder, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_folder', to='iam.folder')),
                ('is_published', models.BooleanField(default=False, verbose_name='published')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annotation', models.TextField(blank=True, null=True, verbose_name='Annotation')),
                ('folder', models.ForeignKey(default=iam.models.Folder.get_root_folder, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_folder', to='iam.folder')),
                ('library', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='frameworks', to='core.library')),
                ('is_published', models.BooleanField(default=False, verbose_name='published')),
                ('max_score', models.IntegerField(default=100, verbose_name='Maximum score')),
                ('min_score', models.IntegerField(default=0, verbose_name='Minimum score')),
                ('scores_definition', models.JSONField(blank=True, null=True, verbose_name='Score definition')),
                ('implementation_groups_definition', models.JSONField(blank=True, null=True, verbose_name='Implementation groups definition')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lc_status', models.CharField(choices=[('undefined', 'Undefined'), ('in_design', 'Design'), ('in_dev', 'Development'), ('in_prod', 'Production'), ('eol', 'EndOfLife'), ('dropped', 'Dropped')], default='in_design', max_length=20, verbose_name='Status')),
                ('folder', models.ForeignKey(default=iam.models.Folder.get_root_folder, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_folder', to='iam.folder')),
                ('is_published', models.BooleanField(default=False, verbose_name='published')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('framework', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.framework', verbose_name='Framework')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.project', verbose_name='Project')),
                ('is_published', models.BooleanField(default=False, verbose_name='published')),
                ('max_score', models.IntegerField(null=True, verbose_name='Maximum score')),
                ('min_score', models.IntegerField(null=True, verbose_name='Minimum score')),
                ('scores_definition', models.JSONField(blank=True, null=True, verbose_name='Score definition')),
                ('selected_implementation_groups', models.JSONField(blank=True, null=True, verbose_name='Selected implementation groups')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider', models.CharField(blank=True, max_length=200, null=True, verbose_name='Provider')),
                ('folder', models.ForeignKey(default=iam.models.Folder.get_root_folder, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_folder', to='iam.folder')),
                ('library', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='risk_matrices', to='core.library')),
                ('is_published', models.BooleanField(default=False, verbose_name='published')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.project', verbose_name='Project')),
                ('reviewers', models.ManyToManyField(blank=True, related_name='%(class)s_reviewers', to=settings.AUTH_USER_MODEL, verbose_name='Reviewers')),
                ('risk_matrix', models.ForeignKey(help_text='WARNING! After choosing it, you will not be able to change it', on_delete=django.db.models.deletion.PROTECT, to='core.riskmatrix', verbose_name='Risk matrix')),
                ('is_published', models.BooleanField(default=False, verbose_name='published')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('folder', models.ForeignKey(default=iam.models.Folder.get_root_folder, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_folder', to='iam.folder')),
                ('reference_control', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.referencecontrol', verbose_name='Reference Control')),
                ('is_published', models.BooleanField(default=False, verbose_name='published')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_published', models.BooleanField(default=False, verbose_name='published')),
                ('folder', models.ForeignKey(default=iam.models.Folder.get_root_folder, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_folder', to='iam.folder')),
                ('library', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='threats', to='core.library')),
            ],
            options={
                'verbose_name': 'Threat',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('folder', models.ForeignKey(default=iam.models.Folder.get_root_folder, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_folder', to='iam.folder')),
                ('framework', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='requirement_nodes', to='core.framework', verbose_name='Framework')),
                ('reference_controls', models.ManyToManyField(blank=True, related_name='requirements', to='core.referencecontrol', verbose_name='Reference controls')),
                ('threats', models.ManyToManyField(blank=True, related_name='requirements', to='core.threat', verbose_name='Threats')),
                ('is_published', models.BooleanField(default=False, verbose_name='published')),
                ('implementation_groups', models.JSONField(null=True, verbose_name='Implementation groups')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=200, verbose_name='Name')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('existing_controls', models.TextField(blank=True, help_text='The existing controls to manage this risk. Edit the risk scenario to add extra applied controls.', max_length=2000, verbose_name='Existing controls')),
                ...
                ('strength_of_knowledge', models.IntegerField(default=-1, help_text='The strength of the knowledge supporting the assessment', verbose_name='Strength of Knowledge')),
                ('justification', models.CharField(blank=True, max_length=500, null=True, verbose_name='Justification')),
                ('assets', models.ManyToManyField(blank=True, help_text='Assets impacted by the risk scenario', related_name='risk_scenarios', to='core.asset', verbose_name='Assets')),
                ('risk_assessment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='risk_scenarios', to='core.riskassessment', verbose_name='RiskAssessment')),
                ('applied_controls', models.ManyToManyField(blank=True, related_name='risk_scenarios', to='core.appliedcontrol', verbose_name='Applied controls')),
                ('threats', models.ManyToManyField(blank=True, related_name='risk_scenarios', to='core.threat', verbose_name='Threats')),
                ('is_published', models.BooleanField(default=False, verbose_name='published')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compliance_assessment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requirement_assessments', to='core.complianceassessment', verbose_name='Compliance assessment')),
                ('evidences', models.ManyToManyField(blank=True, related_name='requirement_assessments', to='core.evidence', verbose_name='Evidences')),
                ('folder', models.ForeignKey(default=iam.models.Folder.get_root_folder, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_folder', to='iam.folder')),
                ('requirement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.requirementnode', verbose_name='Requirement')),
                ('applied_controls', models.ManyToManyField(blank=True, related_name='requirement_assessments', to='core.appliedcontrol', verbose_name='Applied controls')),
                ('is_published', models.BooleanField(default=False, verbose_name='published')),
                ('is_scored', models.BooleanField(default=False, verbose_name='Is scored')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('folder', models.ForeignKey(default=iam.models.Folder.get_root_folder, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_folder', to='iam.folder')),
                ('framework', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='requirement_levels', to='core.framework', verbose_name='Framework')),
                ('is_published', models.BooleanField(default=False, verbose_name='published')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('justification', models.CharField(blank=True, max_length=500, null=True, verbose_name='Justification')),
                ('approver', models.ForeignKey(blank=True, help_text='Risk owner and approver identity', max_length=200, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Approver')),
                ('folder', models.ForeignKey(default=iam.models.Folder.get_root_folder, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_folder', to='iam.folder')),
                ('risk_scenarios', models.ManyToManyField(help_text='Select the risk scenarios to be accepted, attention they must be part of the chosen domain', to='core.riskscenario', verbose_name='Risk scenarios')),
                ('is_published', models.BooleanField(default=False, verbose_name='published')),
            ],
            options={
        ...
        migrations.RunPython(
            code=core.migrations.0010_rename_score_definition_framework_scores_definition_and_more.fix_well_known_scores,
        ),
        migrations.RunPython(
            code=core.migrations.0011_auto_20240501_1342.fix_well_known_scores,
        ),
        ...
        migrations.AlterModelOptions(
            name='loadedlibrary',
            options={'abstract': False, 'unique_together': {('urn', 'locale', 'version')}},
        ),
        migrations.AlterField(
            model_name='framework',
            name='library',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('annotation', models.TextField(blank=True, null=True, verbose_name='Annotation')),
                ('urn', models.CharField(blank=True, max_length=100, null=True, verbose_name='URN')),
                ('copyright', models.CharField(blank=True, max_length=4096, null=True, verbose_name='Copyright')),
                ('version', models.IntegerField(verbose_name='Version')),
                ('packager', models.CharField(blank=True, help_text='Packager of the library', max_length=100, null=True, verbose_name='Packager')),
        ...
        migrations.RunPython(
            code=core.migrations.0012_alter_appliedcontrol_updated_at_and_more.adapt_libraries,
        ),
        migrations.AddField(
            model_name='requirementnode',
        ...
        migrations.RunPython(
            code=core.migrations.0014_auto_20240522_1731.fix_urns_for_enisa_5g_scm,
        ),
    ]
