...
class Command(BaseCommand):
    help = "Create functional test databases"
    ...
    def handle(self, *args, **options):
        ...
        backup_file_path = sqlite_file_path.parent / INITIAL_BACKUP_FNAME
        blank_test_db_file_path = sqlite_file_path.parent / "tests" / BLANK_DB_NAME
