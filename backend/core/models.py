...
class RiskAssessment(Assessment):
    ...
    def duplicate(
        ...
        duplicated_risk_assessment = RiskAssessment.objects.create(
            name=name,
        ...
        duplicated_risk_assessment.authors.set(self.authors.all())
        duplicated_risk_assessment.reviewers.set(self.reviewers.all())
        ...
        for scenario in self.risk_scenarios.all():
            ...
            if duplicated_risk_assessment.folder in [self.folder] + [
        ...
        return duplicated_risk_assessment
