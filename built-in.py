...
ra1 = RoleAssignment.objects.create(isUserGroup=True, user_group=administrators, role=administrator)
ra1.folders.add(root)
ra2 = RoleAssignment.objects.create(isUserGroup=True, user_group=global_auditors, role=auditor)
